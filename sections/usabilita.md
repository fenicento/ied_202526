...
L'interazione deve essere guidata da:

</div>

<div class="mt-8 flex gap-12">
  <div>
    <p><b>Inviti all'azione</b></p>
    <p class="text-sm">Possibilità d'azione implicite</p>
  </div>
  <div>
    <p><b>Segnali espliciti</b></p>
    <p class="text-sm">Indicazioni visive, sonore, aptiche</p>
  </div>
</div>
...
<div class="flex items-center justify-center mt-4">
    <img src="/media/zoolander.webp"/>
</div>


---
layout: image-right
image: /media/complex.jpg
---

# Usabilità e complessità
...
---
layout: image-right
image: /media/clippy.webp
---


# Usabilità vs istruzioni umane
...
<Dida title="ART+COM - Bauhaus Infinity Archive" subtitle="Bauhaus Archive, Berlin" link="https://artcom.de/en/?project=bauhaus-infinity-archive-2" bgColor="#e4ca00"></Dida>
</div>